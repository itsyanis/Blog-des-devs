...
Route::prefix('post')->group(function() {
    ...
    Route::post('publish', [PostController::class, 'publish_post'])->name('post.publish');
    ...
    Route::get('unpublished/{slug}', [PostController::class, 'show_unpublished'])->name('unpublished.show');
});
